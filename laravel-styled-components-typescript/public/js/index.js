...
!(function (e) {
  ...
  function (e, t, n) {
      ...
      ;(null !== l
        ...
        r || null === l
          ? (function (e) {
              return (
                !!W.call($, e) ||
                (!W.call(Q, e) && (B.test(e) ? ($[e] = !0) : ((Q[e] = !0), !1)))
              )
            })(t) &&
    ...
    function fr(e, t, n) {
      return (
        ((e = Qn.getPooled(sr.change, e, t, n)).type = 'change'), M(n), Dn(e), e
      )
    }
    var dr = null,
      pr = null
    ...
    function Ql(e) {
      return null === Fl ? ((Fl = [e]), (Ll = xl(_l, Hl))) : Fl.push(e), Ml
    }
    function $l() {
      if (null !== Ll) {
        var e = Ll
    ...
    function Ki(e, t, n, r, l, i) {
      if (
        ...
        (t.updateQueue = null),
        (t.expirationTime = 0),
        (Ui.current = null === e || null === e.memoizedState ? vo : yo),
        (e = n(r, l)),
        t.expirationTime === ji)
      ) {
        i = 0
    ...
    function ho(e, t, n) {
      ...
      if (
        ...
        (Qi = !0), (l.expirationTime = ji), (Vi.expirationTime = ji)
      else {
        if (
          0 === e.expirationTime &&
    ...
    function Ya(e, t) {
      ...
      return (
        null !== l && (Ta === l && (ou(t), _a === xa && Ru(l, Ca)), Iu(l, t)), l
      )
    }
    function Xa(e) {
    ...
    function Ga(e) {
      if (0 !== e.lastExpiredTime)
        (e.callbackExpirationTime = 1073741823),
          ...
          (e.callbackNode = Ql(Za.bind(null, e)))
      else {
        var t = Xa(e),
          n = e.callbackNode
        if (0 === t)
    ...
    function Ja(e, t) {
      if ((($a = 0), t)) return Fu(e, (t = Ha())), Ga(e), null
      var n = Xa(e)
      if (0 !== n) {
    ...
    function lu() {
      var e = ya.current
      return (ya.current = go), null === e ? go : e
    }
    function iu(e, t) {
      e < Na && 2 < e && (Na = e),
    ...
    function pu(e, t) {
      ...
      if (
        ...
        ;(Ht = !!hn), (gn = hn = null), (e.current = n), (Fa = l)
        do {
          try {
            for (w = e; null !== Fa; ) {
              var E = Fa.effectTag
    ...
    function bu(e, t, n) {
      ...
      null !== r && r.delete(t),
        Ta === e && Ca === n
          ? _a === xa || (_a === ka && 1073741823 === Na && Al() - Ia < 500)
            ? nu(e, Ca)
            : (Ra = !0)
          : Mu(e, n) &&
      ...
      (t.unstable_scheduleCallback = function (e, n, o) {
        ...
        return (
          ...
          u > a
            ? ((e.sortIndex = u),
              S(z, e),
              null === C(N) && e === C(z) && (L ? i() : (L = !0), l(U, u - a)))
            : ((e.sortIndex = o), S(N, e), F || I || ((F = !0), r(A))),
          e
        )
      }),
    ...
    function p(e, t) {
      for (var n = 0; n < e.length; n++) {
        ...
        if (l) {
          ...
          for (; o < r.parts.length; o++) l.parts.push(b(r.parts[o], t))
        } else {
          var a = []
  ...
  function (e, t, n) {
    ...
    Object(l.render)(r.createElement(i, null), document.getElementById('app'))
  },
])
